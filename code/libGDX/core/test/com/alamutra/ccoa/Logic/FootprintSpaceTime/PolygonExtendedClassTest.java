...
class PolygonExtendedClassTest {
    ...
    PolygonExtended square = new PolygonExtendedClass(Arrays.<Point>asList(new PointClass[]{
            new PointClass(10, 10),
            new PointClass(10, 20),
            new PointClass(20, 20),
            new PointClass(20, 10)
    ...
    private PolygonExtended triangle = new PolygonExtendedClass(Arrays.<Point>asList(new PointClass[]{
            new PointClass(10, 10),
            new PointClass(20, 10),
    ...
    PolygonExtended glassesPolygon = new PolygonExtendedClass(Arrays.<Point>asList(new PointClass[]{
            new PointClass(0, 15),
