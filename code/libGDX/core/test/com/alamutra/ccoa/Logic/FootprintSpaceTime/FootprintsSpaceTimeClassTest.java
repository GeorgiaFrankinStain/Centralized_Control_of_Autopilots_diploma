...
class FootprintsSpaceTimeClassTest { //FIXME add test add path of moving object with speed 0
    ...
    PolygonExtended areaRendering = new PolygonExtendedClass(Arrays.asList(new Point[]{
            new PointClass(0, 0),
...
/*
    ...
    private class TesterOneMarkClass implements TesterOneMark, com.alamutra.ccoa.Logic.FootprintSpaceTime.TesterOneMarkClass {
    ...
    private Path verticalPathMoreOneStep = new PathClass(Arrays.asList(new Point[]{
            new PointClass(0, 0),
    ...
    private Path pathStanding = new PathClass(Arrays.asList(new Point[]{
            new PointClass(0, 0)
    }));
    ...
    private Path zigZagPath = new PathClass(Arrays.asList(new Point[]{
            new PointClass(0, 0),
    ...
    private Path zigZagPathWithTail = new PathClass(Arrays.asList(new Point[]{
            new PointClass(0, 0),
            new PointClass(100, 0),
            new PointClass(100, 100),
            new PointClass(200, 100),
    ...
    private Path standingPath = new PathClass(Arrays.asList(new Point[]{
            new PointClass(0, 0)
    }));
